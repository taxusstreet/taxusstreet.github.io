...
var Insta = function (_Component) {
  _inherits(Insta, _Component);

  function Insta() {
    _classCallCheck(this, Insta);

    return _possibleConstructorReturn(this, (Insta.__proto__ || Object.getPrototypeOf(Insta)).apply(this, arguments));
  }
...
var _norm = __webpack_require__(14);
...
var RoastView = function (_Component) {
  _inherits(RoastView, _Component);

  function RoastView(props) {
    _classCallCheck(this, RoastView);

    var _this = _possibleConstructorReturn(this, (RoastView.__proto__ || Object.getPrototypeOf(RoastView)).call(this, props));

    _this.componentWillMount = function () {
      var id = _this.props.match.params.id;
      var roast = data.roasts.filter(function (obj) {
        return (0, _norm2.default)(obj.title) == id;
      })[0];
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'roast-text-wrapper__left' },
                _react2.default.createElement(
                  'h1',
                  {
                  ...
                  this.state.roast.title
                ),
                _react2.default.createElement(
                  'p',
                  { className: 'sub-head' },
                  this.state.roast.origin
                ),
                _react2.default.createElement(
                  'p',
...
var ShopView = function (_Component) {
  _inherits(ShopView, _Component);

  function ShopView(props) {
    _classCallCheck(this, ShopView);

    var _this = _possibleConstructorReturn(this, (ShopView.__proto__ || Object.getPrototypeOf(ShopView)).call(this, props));

    var item = data.shop.filter(function (obj) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'shop-text-wrapper' },
            _react2.default.createElement(
              'div',
              { className: 'shop-text-wrapper__left' },
              _react2.default.createElement(
                'h1',
              ...
              _react2.default.createElement(
                'div',
                { className: 'buy-button' },
                _react2.default.createElement('div', { id: "product-component-" + this.state.item.button.container })
              )
            )
          )
        )
...
var _ShopView = __webpack_require__(39);
...
var _RoastsSection = __webpack_require__(85);

var _RoastsSection2 = _interopRequireDefault(_RoastsSection);

var _ShopSection = __webpack_require__(88);

var _ShopSection2 = _interopRequireDefault(_ShopSection);

var _Insta = __webpack_require__(37);
...
var _RoastContainer = __webpack_require__(86);
...
var RoastsSection = function (_Component) {
  ...
  function RoastsSection(props) {
    ...
    _this.clearCurrentRoast = function () {
      _this.setState(function () {
        return {
          currentRoast: null
        };
      ...
      _this.props.updateUrl('/roasts');

      document.getElementsByTagName('body')[0].classList.remove('lock');
    };

    _this.componentDidUpdate = function () {
      if (_this.props.currentRoast && !_this.state.currentRoast) {
        _this.setState(function () {
          return {
            currentRoast: data.roasts.filter(function (roast) {
              if (roast.title.split(" ").join("").toLowerCase() == _this.props.currentRoast) {
                return roast;
              }
            })[0]
          };
  ...
  _createClass(RoastsSection, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'roasts-section page-section', id: 'coffees' },
        _react2.default.createElement(
          'div',
...
var _Bean = __webpack_require__(87);
...
var RoastContainer = function RoastContainer(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'h3',
        { className: 'roast-container__price' },
        '$',
        props.roast.price
      ),
      _react2.default.createElement('div', { className: 'roast-container__bar roast-container__top-bar', style: { backgroundColor: props.roast.color } }),
      _react2.default.createElement('div', { className: 'roast-container__bar roast-container__bottom-bar', style: { backgroundColor: props.roast.color } }),
      !props.roast['in-stock'] ? _react2.default.createElement(
        'div',
        { className: 'out-of-stock' },
        'OUT OF STOCK'
      ) : null
...
var _ShopItem = __webpack_require__(89);
...
var ShopSection = function (_Component) {
  ...
  function ShopSection(props) {
    ...
    _this.handleViewShopItem = function (shopItemToView) {
      _this.setState(function () {
        return {
    ...
    _this.state = {
      shopItems: _this.props.shopItems,
      currentShopItem: null,
  ...
  _createClass(ShopSection, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'shop-section page-section', id: 'shop' },
        _react2.default.createElement(
          'div',
          { className: 'page-section__wrapper' },
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'page-section__items-centered' },
            this.state.shopItems.map(function (item, i) {
              return _react2.default.createElement(_ShopItem2.default, { key: i, item: item, handleViewShopItem: _this2.handleViewShopItem });
            })
          )
        ),
...
var ShopItem = function ShopItem(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _reactRouterDom.Link,
      { to: '/shop/' + (0, _norm2.default)(props.item.title) },
      _react2.default.createElement('img', { src: "images/" + props.item.images[0] }),
      _react2.default.createElement(
        'div',
        { className: 'shop-item__text' },
        _react2.default.createElement(
          'h3',
          null,
          props.item.title
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Pick up, wholesale, questions, or concerns? Reach out, and we\'ll get back to you soon.'
        )
      )
    ),
    _react2.default.createElement(
...
var Footer = function Footer() {
  return _react2.default.createElement(
    "footer",
    null,
    _react2.default.createElement("img", { className: "footer-image", src: "images/footer-logo-thing.png" }),
    _react2.default.createElement(
      "p",
      { className: "footer__copyright" },
      "\xA9Taxus Street Coffee 2018 \u2022 All rights reserved"
    )
  );
};
